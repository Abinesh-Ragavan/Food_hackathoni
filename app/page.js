...
export default function Home() {
  ...
  return (
    <>
      <div className=' abi_bhu font-sans scroll-smooth'>
        ...
        <div className={`${ubuntu.className}  flex justify-center item-center flex-col sm:px-4 md:pt-8 md:px-12 pt-6 bg-gradient-to-tr from-orange-200 h-[80vh] md:h-[84vh]`}>
          <div className=' abi_bhu flex md:flex-row flex-col justify-center items-center '>
        ...
        <div className={`${ubuntu.className}  details h-[180vh] lg:h-[60vh] relative`}>
          <div className=' abi_bhu cardcontain flex lg:flex-row flex-col justify-center items-center gap-24 lg:gap-6'>
            ...
            <div className=' abi_bhu card text-center -mt-[10vh] pt-6 pl-4 pr-6 bg-gray-200/90  transition-transform rounded-xl hover:scale-105 hover:shadow-2xl h-[55vh] w-[80vw] lg:w-[25vw]'>
                <div className="image mb-4 h-[20vh] w-full grid place-items-center">
